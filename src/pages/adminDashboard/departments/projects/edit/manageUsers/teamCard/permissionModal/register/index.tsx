...
const permissionsModel = [
    ...
    {
        label: 'Gerenciar Sessions',
        checked: false,
    },
    {
        label: 'Gerenciar Tasks',
        checked: false,
    },
    {
...
const RegisterPermission: React.FC<Props> = (props: Props) => {
    ...
    const onSubmit = useCallback(
        async (data: PermissionModel) => {
            const auxData = {
                name: data.name,
                editProject: permissions[0].checked,
                deleteProject: permissions[0].checked,
                session: permissions[1].checked,
                task: permissions[2].checked,
                taskResponsible: permissions[2].checked,
                createTemplate: permissions[3].checked,
            };
            try {
                await projectPermApi.create(
                    company!.companyId,
        ...
        [company, department, permissions, handleClose, project, updateProject]
    );
