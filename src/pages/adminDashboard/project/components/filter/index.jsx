...
class MTableFilterRow extends React.Component {
    ...
    LookupFilter = ({ columnDef }) => {
        ...
        return (
            <FormControl style={{ width: '100%', background: '#F5F5F5' }}>
                <InputLabel
                    htmlFor={
    ...
    renderDateTypeFilter = columnDef => {
        ...
        if (columnDef.type === 'date') {
            dateInputElement = (
                <DatePicker inputVariant="standard" {...pickerProps} />
            );
    ...
    render() {
        ...
        return (
            <>
                {this.props.filter && (
                    <Grow in={this.props.filter} timeout={600}>
                        <TableRow
                            style={{ height: 10, ...this.props.filterRowStyle }}
                        >
                            {columns}
                        </TableRow>
                    </Grow>
